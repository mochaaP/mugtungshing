...
class Pangu {
  spacing (text: string): string {
    ...
    return text
      .replace(ALPHA_NUMBER_CJK, '$1$2 $3')
      .replace(ALPHA_CJK, '$1 $2')
      .replace(CJK_ALPHA, '$1 $2')
      .replace(NUMBER_CJK, '$1 $2')
      .replace(CJK_NUMBER, '$1 $2')
      .replace(CJK_AND_ALPHA, '$1 $2 $3')
      .replace(ALPHA_AND_CJK, '$1 $2 $3')
      .replace(ALPHA_SYMBOL_CJK, '$1$2 $3')
      .replace(CJK_SYMBOL_ALPHA, '$1 $2$3')
      .replace(NUMBER_SYMBOL_CJK, '$1$2 $3')
      .replace(CJK_SYMBOL_NUMBER, '$1 $2$3')
      .replace(CJK_SYMBOL_SYMBOL, '$1 $2$3')
      .replace(SYMBOL_SYMBOL_CJK, '$1$2 $3')
      .replace(BRACKET_CJK, '$1 $2')
      .replace(CJK_BRACKET, '$1 $2')
      .replace(CJK_SYMBOL_CJK_SYMBOL_CJK, '$1 $2 $3 $4 $5')
      .replace(CJK_SYMBOL_CJK, '$1 $2 $3')
      .replace(CJK_ACCOUNT_CJK, '$1 $3$5$7 $9')
  }
}
