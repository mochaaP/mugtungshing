// built from vendor <https://github.com/GoogleChromeLabs/native-url> with whatwg-url
/* eslint-disable */
...
var require_decode = __commonJS({
  "node_modules/querystring/decode.js"(exports, module) {
    ...
    module.exports = function(qs3, sep, eq, options) {
      sep = sep || "&";
      eq = eq || "=";
      var obj = {};
      if (typeof qs3 !== "string" || qs3.length === 0) {
        return obj;
      }
      var regexp = /\+/g;
      qs3 = qs3.split(sep);
      ...
      for (var i = 0; i < len; ++i) {
        var x = qs3[i].replace(regexp, "%20"), idx = x.indexOf(eq), kstr, vstr, k, v;
        if (idx >= 0) {
          kstr = x.substr(0, idx);
          vstr = x.substr(idx + 1);
        } else {
...
var require_utils = __commonJS({
  "node_modules/whatwg-url/dist/utils.js"(exports, module) {
    "use strict";
...
var require_infra = __commonJS({
  "node_modules/whatwg-url/dist/infra.js"(exports, module) {
    "use strict";
...
var require_encoding = __commonJS({
  "node_modules/whatwg-url/dist/encoding.js"(exports, module) {
    "use strict";
...
var require_percent_encoding = __commonJS({
  "node_modules/whatwg-url/dist/percent-encoding.js"(exports, module) {
    "use strict";
...
var require_url_state_machine = __commonJS({
  "node_modules/whatwg-url/dist/url-state-machine.js"(exports, module) {
    "use strict";
...
var require_urlencoded = __commonJS({
  "node_modules/whatwg-url/dist/urlencoded.js"(exports, module) {
    "use strict";
...
var require_Function = __commonJS({
  "node_modules/whatwg-url/dist/Function.js"(exports) {
    "use strict";
    ...
    exports.convert = (value, { context = "The provided value" } = {}) => {
      ...
      function invokeTheCallbackFunction(...args) {
        ...
        callResult = conversions["any"](callResult, { context });
        return callResult;
      }
...
var require_URLSearchParams_impl = __commonJS({
  "node_modules/whatwg-url/dist/URLSearchParams-impl.js"(exports) {
    "use strict";
...
var require_URLSearchParams = __commonJS({
  "node_modules/whatwg-url/dist/URLSearchParams.js"(exports) {
    "use strict";
    var conversions = require_lib();
    var utils = require_utils();
    ...
    function makeWrapper(globalObject) {
      if (globalObject[ctorRegistrySymbol] === void 0) {
    ...
    exports.install = (globalObject, globalNames) => {
      ...
      class URLSearchParams2 {
        ...
        forEach(callback) {
          ...
          callback = Function2.convert(callback, {
      ...
      globalObject[ctorRegistrySymbol][interfaceName] = URLSearchParams2;
...
var require_URL_impl = __commonJS({
  "node_modules/whatwg-url/dist/URL-impl.js"(exports) {
    "use strict";
...
var require_URL = __commonJS({
  "node_modules/whatwg-url/dist/URL.js"(exports) {
    "use strict";
    var conversions = require_lib();
    var utils = require_utils();
    var implSymbol = utils.implSymbol;
    ...
    exports.install = (globalObject, globalNames) => {
      ...
      globalObject[ctorRegistrySymbol][interfaceName] = URL3;
      Object.defineProperty(globalObject, interfaceName, {
        configurable: true,
        writable: true,
        value: URL3
...
// src/parse.js
var import_querystring2 = __toModule(require_querystring());

// src/format.js
var import_querystring = __toModule(require_querystring());

// third_party/format.js
function format_default(urlObj, qs3, slashedProtocols4) {
  ...
  if (query && typeof query === "object") {
    query = qs3.encode(query);
  }
  let search = urlObj.search || query && `?${query}` || "";
  if (protocol && protocol.substr(-1) !== ":")
    protocol += ":";
  if (urlObj.slashes || (!protocol || slashedProtocols4.test(protocol)) && host !== false) {
    host = "//" + (host || "");
...
function format_default2(urlObj) {
  if (typeof urlObj === "string") {
    urlObj = parse_default(urlObj);
  }
  const { protocol, host, pathname, search, hash } = format_default(urlObj, import_querystring.default, slashedProtocols);
...
// src/resolve.js
var resolveProtocolRegex = /^([a-z0-9.+-]*:\/\/\/)([a-z0-9.+-]:\/*)?/i;
var slashedProtocols2 = /https?|ftp|gopher|file/;
function resolve(fromUrl, toUrl) {
  let parsedFrom = typeof fromUrl === "string" ? parse_default(fromUrl) : fromUrl;
  fromUrl = typeof fromUrl === "object" ? format_default2(fromUrl) : fromUrl;
  let parsedTo = parse_default(toUrl);
  let prefix = "";
  ...
  let resolved = new URL(toUrl, normalizedFromUrl).toString().replace(BASE_URL, "");
  ...
  if (!slashedProtocols2.test(resolved) && !~toUrl.indexOf(".") && fromUrl.slice(-1) !== "/" && toUrl.slice(-1) !== "/" && resolved.slice(-1) === "/") {
...
function resolveObject(fromUrl, toUrl) {
  return parse_default(resolve(fromUrl, toUrl));
}

// src/url.js
function Url() {
}
Url.prototype.parse = parse_default;
Url.prototype.format = format_default2;
Url.prototype.resolve = resolve;
Url.prototype.resolveObject = resolve;

// src/parse.js
var slashedProtocols3 = /^https?|ftp|gopher|file/;
var urlRegex = /^(.*?)([#?].*)/;
var protocolRegex = /^([a-z0-9.+-]*:)(\/{0,3})(.*)/i;
var slashesRegex = /^([a-z0-9.+-]*:)?\/\/\/*/i;
var ipv6Regex = /^([a-z0-9.+-]*:)(\/{0,2})\[(.*)\]$/i;
function decodePath(url) {
  return url.replace(/['^|`]/g, (char) => "%" + char.charCodeAt().toString(16).toUpperCase()).replace(/((?:%[0-9A-F]{2})+)/g, (_, seq) => {
    try {
...
function parse_default(urlStr, parseQs = false, slashesDenoteHost = false) {
  ...
  const protocolMatch = !/(^javascript)/.test(urlStr) && urlStr.match(protocolRegex);
  let slashes = slashesRegex.test(urlStr);
  let protocolPrefix = "";
  if (protocolMatch) {
    if (!slashedProtocols3.test(protocolMatch[1])) {
  ...
  let portMatch = (slashesMatch ? slashesMatch[1] : urlStr).match(/^https?:\/\/[^/]+(:[0-9]+)(?=\/|$)/);
  ...
  try {
    ...
    err = e;
    if (!protocolPrefix && !slashesDenoteHost && /^\/\//.test(urlStr) && !/^\/\/.+[@.]/.test(urlStr)) {
      preSlash = "/";
  ...
  res.hostname = url.hostname === HOST ? "" : url.hostname.replace(/(\[|\])/g, "");
  ...
  res.query = parseQs ? import_querystring2.default.decode(url.search.substr(1)) : res.search.substr(1);
  res.pathname = preSlash + (protocolMatch ? decodePath(url.pathname) : url.pathname);
  if (res.protocol === "about:" && res.pathname === "blank") {
    res.protocol = "";
    res.pathname = "";
  }
  if (err && urlStr[0] !== "/")
    res.pathname = res.pathname.substr(1);
  if (protocolPrefix && !slashedProtocols3.test(protocolPrefix) && urlStr.slice(-1) !== "/" && res.pathname === "/") {
    res.pathname = "";
  }
  res.path = res.pathname + res.search;
  res.auth = [url.username, url.password].map(decodeURIComponent).filter(Boolean).join(":");
  res.port = url.port;
  if (portSuffix && !res.host.endsWith(portSuffix)) {
    res.host += portSuffix;
    res.port = portSuffix.slice(1);
  }
  res.href = preSlash ? `${res.pathname}${res.search}${res.hash}` : format_default2(res);
  const excludedKeys = /^(file)/.test(res.href) ? ["host", "hostname"] : [];
  Object.keys(res).forEach((k) => {
    if (!~excludedKeys.indexOf(k))
      res[k] = res[k] || null;
  });
  return res;
}
...
// src/index.js
var import_whatwg_url = __toModule(require_whatwg_url());
